...
use Monei\Model\SubscriptionStatus;
...
class SubscriptionStatusTest extends TestCase
{
    ...
    public function testSubscriptionStatus()
    {
        ...
        $this->assertEquals('TRIALING', SubscriptionStatus::TRIALING);
        $this->assertEquals('ACTIVE', SubscriptionStatus::ACTIVE);
        $this->assertEquals('PAST_DUE', SubscriptionStatus::PAST_DUE);
        $this->assertEquals('PAUSED', SubscriptionStatus::PAUSED);
        $this->assertEquals('CANCELED', SubscriptionStatus::CANCELED);
    }
}
