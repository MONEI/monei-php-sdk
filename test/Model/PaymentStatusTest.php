...
class PaymentStatusTest extends TestCase
{
    ...
    public function testPaymentStatus()
    {
        ...
        $this->assertEquals('SUCCEEDED', PaymentStatus::SUCCEEDED);
        $this->assertEquals('PENDING', PaymentStatus::PENDING);
        $this->assertEquals('FAILED', PaymentStatus::FAILED);
        $this->assertEquals('CANCELED', PaymentStatus::CANCELED);
        $this->assertEquals('REFUNDED', PaymentStatus::REFUNDED);
