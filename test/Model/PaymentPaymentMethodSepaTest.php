 ...
 *
 * @category    Class
 * @description PaymentPaymentMethodSepa
 * @package     Monei
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PaymentPaymentMethodSepaTest extends TestCase
{
    ...
    {
        $model = new \Monei\Model\PaymentPaymentMethodSepa();
        $this->assertInstanceOf(\Monei\Model\PaymentPaymentMethodSepa::class, $model);
    }
