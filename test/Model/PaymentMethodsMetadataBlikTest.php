...
/**
 * PaymentMethodsMetadataBlikTest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PaymentMethodsMetadataBlikTest Class Doc Comment
 *
 * @category    Class
 * @description PaymentMethodsMetadataBlik
 * @package     Monei
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PaymentMethodsMetadataBlikTest extends TestCase
{
    /**
     ...
     */
    public function testPaymentMethodsMetadataBlik()
    {
        $model = new \Monei\Model\PaymentMethodsMetadataBlik();
        $this->assertInstanceOf(\Monei\Model\PaymentMethodsMetadataBlik::class, $model);
        ...
        $model = new \Monei\Model\PaymentMethodsMetadataBlik($data);
