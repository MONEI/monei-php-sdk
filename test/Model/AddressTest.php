...
class AddressTest extends TestCase
{
    ...
    public function testPropertyCountry()
    {
        ...
        $this->assertEquals($expected, $address->getCountry());
    }
    ...
    public function testPropertyCity()
    {
        ...
        $this->assertEquals($expected, $address->getCity());
    }
    ...
    public function testPropertyLine1()
    {
        ...
        $address->setLine1($expected);
        $this->assertEquals($expected, $address->getLine1());
    }
    ...
    public function testPropertyLine2()
    {
        $address = new Address();
        $expected = 'Apt 4B';
        $address->setLine2($expected);
        $this->assertEquals($expected, $address->getLine2());
    }
    ...
    public function testPropertyState()
    {
        ...
        $this->assertEquals($expected, $address->getState());
    }
}
