 ...
 *
 * @category    Class
 * @description PaymentPaymentMethodKlarna
 * @package     Monei
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PaymentPaymentMethodKlarnaTest extends TestCase
{
    ...
    {
        $model = new \Monei\Model\PaymentPaymentMethodKlarna();
        $this->assertInstanceOf(\Monei\Model\PaymentPaymentMethodKlarna::class, $model);
    }
