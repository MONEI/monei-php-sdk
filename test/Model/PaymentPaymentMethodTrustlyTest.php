 ...
 *
 * @category    Class
 * @description PaymentPaymentMethodTrustly
 * @package     Monei
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PaymentPaymentMethodTrustlyTest extends TestCase
{
    ...
    {
        $model = new \Monei\Model\PaymentPaymentMethodTrustly();
        $this->assertInstanceOf(\Monei\Model\PaymentPaymentMethodTrustly::class, $model);
    }
