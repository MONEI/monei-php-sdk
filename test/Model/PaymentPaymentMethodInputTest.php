 ...
 *
 * @category    Class
 * @description PaymentPaymentMethodInput
 * @package     Monei
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PaymentPaymentMethodInputTest extends TestCase
{
    ...
    {
        $model = new \Monei\Model\PaymentPaymentMethodInput();
        $this->assertInstanceOf(\Monei\Model\PaymentPaymentMethodInput::class, $model);
    }
