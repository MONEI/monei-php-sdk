...
class POSAuthTokenApi
{
     ...
     *
     * @param  \Monei\Model\CreatePosAuthTokenRequest|null $create_pos_auth_token_request create_pos_auth_token_request (optional)
     ...
     */
    public function create($create_pos_auth_token_request = null, string $contentType = self::contentTypes['create'][0])
    {
     ...
     * Create POS Auth Token
     *
     * @param  \Monei\Model\CreatePosAuthTokenRequest|null $create_pos_auth_token_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['create'] to see the possible values for this operation
     *
     * @throws \Monei\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createWithHttpInfo($create_pos_auth_token_request = null, string $contentType = self::contentTypes['create'][0])
    {
     ...
     */
    public function createAsync($create_pos_auth_token_request = null, string $contentType = self::contentTypes['create'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($create_pos_auth_token_request = null, string $contentType = self::contentTypes['create'][0])
    {
     ...
     */
    public function createRequest($create_pos_auth_token_request = null, string $contentType = self::contentTypes['create'][0])
    {
