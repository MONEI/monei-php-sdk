...
class ApplePayDomainApi
{
     ...
     * @return \OpenAPI\Client\Model\ApplePayDomainRegister200Response|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ApplePayDomainRegister200Response|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->registerAsyncWithHttpInfo($register_apple_pay_domain_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function registerRequest($register_apple_pay_domain_request, string $contentType = self::contentTypes['register'][0])
    {
        ...
        if (isset($register_apple_pay_domain_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($register_apple_pay_domain_request));
            } else {
