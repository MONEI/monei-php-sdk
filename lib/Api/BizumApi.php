...
class BizumApi
{
     ...
     * @return \Monei\Model\BizumValidatePhone200Response|\Monei\Model\BadRequestError|\Monei\Model\UnauthorizedError|\Monei\Model\NotFoundError|\Monei\Model\UnprocessableEntityError|\Monei\Model\InternalServerError|\Monei\Model\ServiceUnavailableError
     */
     ...
     * @throws \Monei\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Monei\Model\BizumValidatePhone200Response|\Monei\Model\BadRequestError|\Monei\Model\UnauthorizedError|\Monei\Model\NotFoundError|\Monei\Model\UnprocessableEntityError|\Monei\Model\InternalServerError|\Monei\Model\ServiceUnavailableError, HTTP status code, HTTP response headers (array of strings)
     */
    public function validatePhoneWithHttpInfo($validate_bizum_phone_request)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Monei\Model\BizumValidatePhone200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Monei\Model\BizumValidatePhone200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Monei\Model\BizumValidatePhone200Response', []),
            ...
            $returnType = '\Monei\Model\BizumValidatePhone200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Monei\Model\BizumValidatePhone200Response',
