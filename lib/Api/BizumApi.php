...
class BizumApi
{
     ...
     * @return \OpenAPI\Client\Model\BizumValidatePhone200Response|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BizumValidatePhone200Response|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->validatePhoneAsyncWithHttpInfo($validate_bizum_phone_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
