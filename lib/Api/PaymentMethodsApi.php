...
class PaymentMethodsApi
{
    ...
    public const contentTypes = ['get' => ['application/json']];
    /**
     ...
     */
    public function get($account_id = null, $payment_id = null, string $contentType = self::contentTypes['get'][0])
    {
        list($response) = $this->getWithHttpInfo($account_id, $payment_id, $contentType);
        return $response;
    }
    /**
     ...
     */
    public function getWithHttpInfo($account_id = null, $payment_id = null, string $contentType = self::contentTypes['get'][0])
    {
        $request = $this->getRequest($account_id, $payment_id, $contentType);
        try {
     ...
     */
    public function getAsync($account_id = null, $payment_id = null, string $contentType = self::contentTypes['get'][0])
    {
        return $this->getAsyncWithHttpInfo($account_id, $payment_id, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAsyncWithHttpInfo($account_id = null, $payment_id = null, string $contentType = self::contentTypes['get'][0])
    {
     ...
     */
    public function getRequest($account_id = null, $payment_id = null, string $contentType = self::contentTypes['get'][0])
    {
