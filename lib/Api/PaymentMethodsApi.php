...
class PaymentMethodsApi
{
     ...
     * @return \OpenAPI\Client\Model\PaymentMethods|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PaymentMethods|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError|\OpenAPIClientModelError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->getAsyncWithHttpInfo($account_id, $payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
