...
class FormDataProcessor
{
    ...
    {
        $opt = ['prefix' => '[', 'suffix' => ']', 'suffix-end' => \true, 'prefix-list' => '[', 'suffix-list' => ']', 'suffix-list-end' => \true];
        if ($start === '') {
            $currentPrefix = '';
            $currentSuffix = '';
        ...
        foreach ($source as $key => $val) {
            ...
            if (is_array($val) && !empty($val)) {
                ...
                $result[$currentName] = \Monei\ObjectSerializer::toString($val);
            }
            $currentName = $start;
        }
        return $result;
    ...
    protected function makeFormSafe($value)
    {
        ...
        return \Monei\ObjectSerializer::toString($value);
    }
    /**
    ...
    protected function processModel(ModelInterface $model): array
    {
        ...
        foreach ($model::openAPITypes() as $name => $type) {
            ...
            $result[$name] = \Monei\ObjectSerializer::toString($value);
        }
        return $result;
    }
    /**
