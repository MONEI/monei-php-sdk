 ...
 */
class CreatePaymentRequest implements \Monei\Model\ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['amount' => 'int', 'currency' => 'string', 'order_id' => 'string', 'callback_url' => 'string', 'complete_url' => 'string', 'fail_url' => 'string', 'cancel_url' => 'string', 'payment_token' => 'string', 'session_id' => 'string', 'generate_payment_token' => 'bool', 'payment_method' => '\Monei\Model\PaymentPaymentMethodInput', 'allowed_payment_methods' => '\Monei\Model\PaymentPaymentMethods', 'transaction_type' => '\Monei\Model\PaymentTransactionType', 'sequence' => '\Monei\Model\PaymentSequence', 'store_id' => 'string', 'point_of_sale_id' => 'string', 'subscription_id' => 'string', 'auto_recover' => 'bool', 'description' => 'string', 'customer' => '\Monei\Model\PaymentCustomer', 'billing_details' => '\Monei\Model\PaymentBillingDetails', 'shipping_details' => '\Monei\Model\PaymentShippingDetails', 'session_details' => '\Monei\Model\PaymentSessionDetails', 'expire_at' => 'float', 'metadata' => 'object'];
    /**
     ...
     */
    protected static $openAPIFormats = ['amount' => 'int32', 'currency' => null, 'order_id' => null, 'callback_url' => null, 'complete_url' => null, 'fail_url' => null, 'cancel_url' => null, 'payment_token' => null, 'session_id' => null, 'generate_payment_token' => null, 'payment_method' => null, 'allowed_payment_methods' => null, 'transaction_type' => null, 'sequence' => null, 'store_id' => null, 'point_of_sale_id' => null, 'subscription_id' => null, 'auto_recover' => null, 'description' => null, 'customer' => null, 'billing_details' => null, 'shipping_details' => null, 'session_details' => null, 'expire_at' => 'int64', 'metadata' => null];
    /**
     * Array of nullable properties. Used for (de)serialization
     *
     * @var boolean[]
     */
    protected static array $openAPINullables = ['amount' => \false, 'currency' => \false, 'order_id' => \false, 'callback_url' => \false, 'complete_url' => \false, 'fail_url' => \false, 'cancel_url' => \false, 'payment_token' => \false, 'session_id' => \false, 'generate_payment_token' => \false, 'payment_method' => \false, 'allowed_payment_methods' => \false, 'transaction_type' => \false, 'sequence' => \false, 'store_id' => \false, 'point_of_sale_id' => \false, 'subscription_id' => \false, 'auto_recover' => \false, 'description' => \false, 'customer' => \false, 'billing_details' => \false, 'shipping_details' => \false, 'session_details' => \false, 'expire_at' => \false, 'metadata' => \false];
    /**
     ...
     * @var string[]
     */
    protected static $attributeMap = ['amount' => 'amount', 'currency' => 'currency', 'order_id' => 'orderId', 'callback_url' => 'callbackUrl', 'complete_url' => 'completeUrl', 'fail_url' => 'failUrl', 'cancel_url' => 'cancelUrl', 'payment_token' => 'paymentToken', 'session_id' => 'sessionId', 'generate_payment_token' => 'generatePaymentToken', 'payment_method' => 'paymentMethod', 'allowed_payment_methods' => 'allowedPaymentMethods', 'transaction_type' => 'transactionType', 'sequence' => 'sequence', 'store_id' => 'storeId', 'point_of_sale_id' => 'pointOfSaleId', 'subscription_id' => 'subscriptionId', 'auto_recover' => 'autoRecover', 'description' => 'description', 'customer' => 'customer', 'billing_details' => 'billingDetails', 'shipping_details' => 'shippingDetails', 'session_details' => 'sessionDetails', 'expire_at' => 'expireAt', 'metadata' => 'metadata'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['amount' => 'setAmount', 'currency' => 'setCurrency', 'order_id' => 'setOrderId', 'callback_url' => 'setCallbackUrl', 'complete_url' => 'setCompleteUrl', 'fail_url' => 'setFailUrl', 'cancel_url' => 'setCancelUrl', 'payment_token' => 'setPaymentToken', 'session_id' => 'setSessionId', 'generate_payment_token' => 'setGeneratePaymentToken', 'payment_method' => 'setPaymentMethod', 'allowed_payment_methods' => 'setAllowedPaymentMethods', 'transaction_type' => 'setTransactionType', 'sequence' => 'setSequence', 'store_id' => 'setStoreId', 'point_of_sale_id' => 'setPointOfSaleId', 'subscription_id' => 'setSubscriptionId', 'auto_recover' => 'setAutoRecover', 'description' => 'setDescription', 'customer' => 'setCustomer', 'billing_details' => 'setBillingDetails', 'shipping_details' => 'setShippingDetails', 'session_details' => 'setSessionDetails', 'expire_at' => 'setExpireAt', 'metadata' => 'setMetadata'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['amount' => 'getAmount', 'currency' => 'getCurrency', 'order_id' => 'getOrderId', 'callback_url' => 'getCallbackUrl', 'complete_url' => 'getCompleteUrl', 'fail_url' => 'getFailUrl', 'cancel_url' => 'getCancelUrl', 'payment_token' => 'getPaymentToken', 'session_id' => 'getSessionId', 'generate_payment_token' => 'getGeneratePaymentToken', 'payment_method' => 'getPaymentMethod', 'allowed_payment_methods' => 'getAllowedPaymentMethods', 'transaction_type' => 'getTransactionType', 'sequence' => 'getSequence', 'store_id' => 'getStoreId', 'point_of_sale_id' => 'getPointOfSaleId', 'subscription_id' => 'getSubscriptionId', 'auto_recover' => 'getAutoRecover', 'description' => 'getDescription', 'customer' => 'getCustomer', 'billing_details' => 'getBillingDetails', 'shipping_details' => 'getShippingDetails', 'session_details' => 'getSessionDetails', 'expire_at' => 'getExpireAt', 'metadata' => 'getMetadata'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('auto_recover', $data ?? [], null);
    ...
    {
        if (is_null($auto_recover)) {
            throw new \InvalidArgumentException('non-nullable auto_recover cannot be null');
        }
