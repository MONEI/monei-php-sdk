...
class Configuration
{
    ...
    public static function getDefaultConfiguration()
    {
        if (self::$defaultConfiguration === null) {
            self::$defaultConfiguration = new \Monei\Configuration();
        }
     ...
     * @return void
     */
    public static function setDefaultConfiguration(\Monei\Configuration $config)
    {
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 1.12.1' . \PHP_EOL;
    ...
    {
        return [["url" => "https://api.monei.com/v1", "description" => "MONEI API v1"]];
    }
    /**
