...
class RecurringPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param PaymentTransactionType|null $transaction_type Same as the `transactionType` parameter from [create payment](https://docs.monei.com/apis/rest/payments-create/). If not sent, it will default in the same transaction type used in the initial payment.
     *
     * @return self
     */
