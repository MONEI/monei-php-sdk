...
class PaymentStatus
{
    ...
    {
        return [self::SUCCEEDED, self::PENDING, self::FAILED, self::CANCELED, self::REFUNDED, self::PARTIALLY_REFUNDED, self::AUTHORIZED, self::EXPIRED, self::PENDING_PROCESSING, self::PAID_OUT];
    }
}
