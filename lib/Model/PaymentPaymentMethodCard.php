...
class PaymentPaymentMethodCard implements ModelInterface, ArrayAccess
{
    ...
    const THREE_D_SECURE_FLOW_CHALLENGE = 'CHALLENGE';
    const THREE_D_SECURE_FLOW_FRICTIONLESS = 'FRICTIONLESS';
    const THREE_D_SECURE_FLOW_FRICTIONLESS_CHALLENGE = 'FRICTIONLESS_CHALLENGE';
    const THREE_D_SECURE_FLOW_DIRECT = 'DIRECT';
    const TOKENIZATION_METHOD_APPLE_PAY = 'applePay';
    const TOKENIZATION_METHOD_GOOGLE_PAY = 'googlePay';
    const TOKENIZATION_METHOD_CLICK_TO_PAY = 'clickToPay';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tokenization_method'] = isset($data['tokenization_method']) ? $data['tokenization_method'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['three_d_secure_flow']) && !in_array($this->container['three_d_secure_flow'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'three_d_secure_flow', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['tokenization_method']) && !in_array($this->container['tokenization_method'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'tokenization_method', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
