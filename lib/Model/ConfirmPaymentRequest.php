...
class ConfirmPaymentRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets payment_token
     *
     * @param string $payment_token A payment token generated by monei.js [UI Components](https://docs.monei.com/docs/monei-js-overview) or a paymentToken [saved after a previous successful payment](https://docs.monei.com/docs/save-payment-method).
     *
     * @return $this
     */
