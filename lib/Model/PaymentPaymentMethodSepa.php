 ...
 */
class PaymentPaymentMethodSepa implements \Monei\Model\ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['accountholder_address' => 'string', 'accountholder_email' => 'string', 'accountholder_name' => 'string', 'country_code' => 'string', 'bank_address' => 'string', 'bank_code' => 'string', 'bank_name' => 'string', 'bic' => 'string', 'last4' => 'string', 'fingerprint' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['accountholder_address' => null, 'accountholder_email' => null, 'accountholder_name' => null, 'country_code' => null, 'bank_address' => null, 'bank_code' => null, 'bank_name' => null, 'bic' => null, 'last4' => null, 'fingerprint' => null];
    /**
     * Array of nullable properties. Used for (de)serialization
     *
     * @var boolean[]
     */
    protected static array $openAPINullables = ['accountholder_address' => \false, 'accountholder_email' => \false, 'accountholder_name' => \false, 'country_code' => \false, 'bank_address' => \false, 'bank_code' => \false, 'bank_name' => \false, 'bic' => \false, 'last4' => \false, 'fingerprint' => \false];
    /**
     ...
     * @var string[]
     */
    protected static $attributeMap = ['accountholder_address' => 'accountholderAddress', 'accountholder_email' => 'accountholderEmail', 'accountholder_name' => 'accountholderName', 'country_code' => 'countryCode', 'bank_address' => 'bankAddress', 'bank_code' => 'bankCode', 'bank_name' => 'bankName', 'bic' => 'bic', 'last4' => 'last4', 'fingerprint' => 'fingerprint'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['accountholder_address' => 'setAccountholderAddress', 'accountholder_email' => 'setAccountholderEmail', 'accountholder_name' => 'setAccountholderName', 'country_code' => 'setCountryCode', 'bank_address' => 'setBankAddress', 'bank_code' => 'setBankCode', 'bank_name' => 'setBankName', 'bic' => 'setBic', 'last4' => 'setLast4', 'fingerprint' => 'setFingerprint'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['accountholder_address' => 'getAccountholderAddress', 'accountholder_email' => 'getAccountholderEmail', 'accountholder_name' => 'getAccountholderName', 'country_code' => 'getCountryCode', 'bank_address' => 'getBankAddress', 'bank_code' => 'getBankCode', 'bank_name' => 'getBankName', 'bic' => 'getBic', 'last4' => 'getLast4', 'fingerprint' => 'getFingerprint'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        $this->setIfExists('accountholder_address', $data ?? [], null);
        $this->setIfExists('accountholder_email', $data ?? [], null);
    ...
    {
        if (is_null($accountholder_address)) {
            throw new \InvalidArgumentException('non-nullable accountholder_address cannot be null');
        }
    ...
    {
        if (is_null($accountholder_email)) {
            throw new \InvalidArgumentException('non-nullable accountholder_email cannot be null');
        }
     ...
     * Sets fingerprint
     *
     * @param string|null $fingerprint Unique identifier for the IBAN. Used to detect duplicate payment methods across customers.
     *
     * @return self
     */
