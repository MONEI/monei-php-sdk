...
class ApplePayCertificate implements \Monei\Model\ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets csr
     *
     * @param string|null $csr The Certificate Signing Request in base64 format. Only present before activation. Use this to create a certificate in Apple Developer Portal.
     *
     * @return self
     */
