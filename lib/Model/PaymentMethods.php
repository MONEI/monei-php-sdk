...
class PaymentMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => '\Monei\Model\PaymentMethodsMetadata',
    ...
    public const PAYMENT_METHODS_COFIDIS = 'cofidis';
    public const PAYMENT_METHODS_COFIDIS_LOAN = 'cofidisLoan';
    ...
    public function getPaymentMethodsAllowableValues()
    {
        return [
            ...
            self::PAYMENT_METHODS_COFIDIS,
            self::PAYMENT_METHODS_COFIDIS_LOAN,
     ...
     *
     * @param string[]|null $payment_methods An array of available payment methods for the account or payment. Possible values include:   - `alipay` - Alipay   - `applePay` - Apple Pay   - `bancontact` - Bancontact   - `bizum` - Bizum   - `blik` - BLIK   - `card` - Credit or debit card   - `cardPresent` - Card present (physical POS)   - `clickToPay` - Click to Pay   - `cofidis` - Cofidis   - `cofidisLoan` - Cofidis Loan   - `eps` - EPS   - `giropay` - Giropay   - `googlePay` - Google Pay   - `iDeal` - iDEAL   - `klarna` - Klarna   - `mbway` - MB WAY   - `multibanco` - Multibanco   - `paypal` - PayPal   - `sepa` - SEPA Direct Debit   - `sofort` - Sofort   - `trustly` - Trustly
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Monei\Model\PaymentMethodsMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \Monei\Model\PaymentMethodsMetadata|null $metadata metadata
     *
     * @return self
     */
     ...
     * Sets merchant_url
     *
     * @param string|null $merchant_url The URL of the merchant's website
     *
     * @return self
     */
